...
export const EN_TEMPLATES = {
  ...
  "change.returned": "The other {min} of {task} changes to the {at} train.",
  "change.returnedLater": "The other {min} of {task} changes to another day's train.",
  "change.rests": "{task} rests tonight.",
  "change.deferred": "{task} ({min}) changes to another day's train.",
  "change.joins": "{task} ({min}) boards at {at}.",
